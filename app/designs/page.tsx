...
export default function Designs() {
  ...
  return (
    <>
      ...
      {isMin && <MinimizedBar title="designs" onRestore={handleRestore} onMaximize={handleRestoreMaximized} onClose={handleClose} animatingOut={dockAnimOut} />}
      ...
      <div className={`t-bg${animClass === "t-win-maximizing" ? " t-outer-maximizing" : animClass === "t-win-unmaximizing" ? " t-outer-unmaximizing" : ""}`} style={{
        ...
        <div className={animClass} style={{
          ...
          <TabsBar
            tabs={[
              { label: "~/cv",      active: false, onClick: () => router.push("/home/terminal") },
