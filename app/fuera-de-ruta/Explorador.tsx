...
import { AGUA_TEXTO, DESNIVEL_TEXTO, EPOCA_TEXTO, filtrosActivos, resumenFiltros, type FiltroActivo } from "@/lib/fuera-de-ruta/resumen";
...
function Tarjeta({ destino: d, zona, num, href, activa, onActivo }: {
  destino: Destino;
  zona: string;
  num: number;
  href: string;
...
function CarruselMovil({ destinos, activo, onActivo, hrefDestino }: {
  destinos: Destino[];
  activo: string | null;
  onActivo: (slug: string | null) => void;
