...
.vE .wf-btn:active { transform: translateY(-1px); }
...
.vE-rail__nav a:active { color: var(--accent); }
...
.vE-themeT__b:active { color: var(--ink); }
...
.vE-recs__nav:active { background: var(--ink); color: var(--bg); transform: translateY(-1px); }
