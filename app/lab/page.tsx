...
const ITEMS: LabItem[] = [
  ...
  { id: "observatorio", num: "09", type: "app",       title: "Observatorio",          description: "Qué se ve en el cielo esta noche, antes de medianoche.",                              status: "available", href: "/apps/observatorio", cta: "Abrir →" },
