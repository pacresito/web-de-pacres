...
const ITEMS: LabItem[] = [
  ...
  { id: "orbitas",     num: "05", type: "app",        title: "Órbitas",               description: "Lanza cuerpos y míralos orbitar, chocar y escapar.",                                  status: "available", href: "/apps/orbitas",     cta: "Abrir →" },
  { id: "espiral",     num: "06", type: "juego",      title: "Espiral",               description: "Dos caminos distintos, una sola decisión.",                                        status: "available", href: "/juegos/espiral",   cta: "Jugar →" },
  { id: "laberinto",   num: "07", type: "juego",      title: "Laberinto",             description: "Inclina el móvil o usa el ratón.",                                                    status: "available", href: "/juegos/laberinto", cta: "Jugar →" },
  { id: "circulo",     num: "08", type: "truco",      title: "Círculo perfecto",      description: "Dibuja el círculo más perfecto que puedas.",                                          status: "available", href: "/trucos/circulo",   cta: "Probar →" },
