...
const ITEMS: LabItem[] = [
  ...
  { id: "espiral",     num: "09", type: "juego",      title: "Espiral",               description: "Dos caminos distintos, una sola decisión.",                                        status: "available", href: "/juegos/espiral",   cta: "Jugar →" },
  { id: "laberinto",   num: "10", type: "juego",      title: "Laberinto",             description: "Inclina el móvil o usa el ratón.",                                                    status: "available", href: "/juegos/laberinto", cta: "Jugar →" },
  { id: "circulo",     num: "11", type: "truco",      title: "Círculo perfecto",      description: "Dibuja el círculo más perfecto que puedas.",                                          status: "available", href: "/trucos/circulo",   cta: "Probar →" },
  { id: "magia",       num: "12", type: "truco",      title: "Magia de la buena",     description: "Piensa en una carta. No me la digas.",                                                status: "available", href: "/trucos/magia",     cta: "Probar →" },
  { id: "letras",      num: "13", type: "easter-egg", title: "Las letras caen",       description: "Algo pasa si sabes dónde pinchar.",                                                   status: "hidden",    href: "/",                cta: "Ir a probarlo →" },
  { id: "color",       num: "14", type: "easter-egg", title: "Cambio de tema",        description: `Cambio de tema dinámico en el diseño "Original".`,                                                               status: "hidden", href: "/home/original", cta: "Ir a probarlo →" },
  { id: "guestbook",   num: "15", type: "easter-egg", title: "Libro de firmas",       description: "Deja tu firma. Como los de toda la vida.",                                            status: "available", href: "/guestbook",       cta: "Firmar →" },
];
