...
assert.strictEqual([...pertenencias.values()].filter((p) => p.porMatrimonio).length, 139, "las que entraron por su pareja");
...
assert.strictEqual(total, 486, "486 pertenencias para 467 personas: el mapa de áreas suma un 4 % de más");
