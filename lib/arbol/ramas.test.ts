...
assert.strictEqual([...pertenencias.values()].filter((p) => p.porMatrimonio).length, 140, "las que entraron por su pareja");
...
assert.strictEqual(total, 489, "489 pertenencias para 471 personas: el mapa de áreas suma un 4 % de más");
