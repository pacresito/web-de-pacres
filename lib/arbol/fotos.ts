...
export const FOTOS: Foto[] = [
  ...
  {
    titulo: "Hermanos Sala Santa Ana",
    tomada: "1952",
    gente: [
      { id: "p537", nombre: "Luis", recuadro: r(780, 537, 554, 4011) },
      { id: "p538", nombre: "Ana", recuadro: r(1214, 1177, 544, 4011) },
      { id: "p442", nombre: "Pepe", recuadro: r(1374, 315, 610, 4011) },
      { id: "p536", nombre: "Juan", recuadro: r(1870, 73, 578, 4011) },
      { id: "p535", nombre: "Antonio", recuadro: r(2174, 789, 670, 4011) },
    ],
  },
  {
  ...
  },
  {
    ...
    tomada: "1990-07",
    gente: [
      { id: "p537", nombre: "Luis", recuadro: r(975, 529, 660, 4328) },
      { id: "p536", nombre: "Juan", recuadro: r(1180, 1651, 828, 4328) },
      { id: "p538", nombre: "Ana", recuadro: r(1820, 516, 570, 4328) },
      { id: "p535", nombre: "Antonio", recuadro: r(2312, 1499, 798, 4328) },
      { id: "p442", nombre: "Pepe", recuadro: r(2462, 403, 598, 4328) },
    ],
  },
  {
  ...
  },
  {
    ...
    tomada: "2026-08-21",
    gente: [
      { id: "p24", nombre: "Carmen", recuadro: r(602, 596, 364, 4414) },
      { id: "p132", nombre: "Santi", recuadro: r(600, 1146, 450, 4414) },
      { id: "p27", nombre: "Juan", recuadro: r(688, 874, 344, 4414) },
      { id: "p131", nombre: "Ana", recuadro: r(1092, 580, 412, 4414) },
      { id: "p134", nombre: "Jara", recuadro: r(1223, 1086, 416, 4414) },
      { id: "p128", nombre: "Javi", recuadro: r(1349, 519, 348, 4414) },
      { id: "p125", nombre: "Lola", recuadro: r(1608, 606, 386, 4414) },
      { id: "p127", nombre: "Mar", recuadro: r(2126, 1050, 404, 4414) },
      { id: "p25", nombre: "Pablo", recuadro: r(2135, 450, 432, 4414) },
      { id: "p130", nombre: "Nora", recuadro: r(2220, 1346, 364, 4414) },
      { id: "p28", nombre: "Luis", recuadro: r(2238, 823, 374, 4414) },
      { id: "p26", nombre: "Lucas", recuadro: r(2563, 856, 364, 4414) },
      { id: "p126", nombre: "Ricardo", recuadro: r(2832, 1049, 446, 4414) },
      { id: "p133", nombre: "Yago", recuadro: r(2879, 659, 372, 4414) },
      { id: "p129", nombre: "Jorge", recuadro: r(3168, 873, 326, 4414) },
    ],
  },
  {
    titulo: "Los 80 de Ángela",
    tomada: "2026-09-18",
    gente: [
      { id: "p131", nombre: "Ana", recuadro: r(768, 1035, 474, 5712) },
      { id: "p445", nombre: "Fran", recuadro: r(1015, 851, 448, 5712) },
      { id: "p449", nombre: "Pedro", recuadro: r(1212, 1403, 390, 5712) },
      { id: "p444", nombre: "Elena", recuadro: r(1362, 1088, 424, 5712) },
      { id: "p447", nombre: "Alicia", recuadro: r(1811, 1352, 404, 5712) },
      { id: "p455", nombre: "Ana", recuadro: r(1832, 923, 432, 5712) },
      { id: "p460", nombre: "Susana", recuadro: r(2028, 2333, 582, 5712) },
      { id: "p446", nombre: "Eva", recuadro: r(2264, 1220, 478, 5712) },
      { id: "p454", nombre: "Josele", recuadro: r(2334, 840, 440, 5712) },
      { id: "p448", nombre: "Mateo", recuadro: r(2492, 1522, 408, 5712) },
      { id: "p132", nombre: "Santi", recuadro: r(2618, 2019, 544, 5712) },
      { id: "p443", nombre: "Ángela", recuadro: r(2718, 1166, 430, 5712) },
      { id: "p450", nombre: "Pablo", recuadro: r(2994, 919, 446, 5712) },
      { id: "p133", nombre: "Yago", recuadro: r(3181, 1197, 416, 5712) },
      { id: "p134", nombre: "Jara", recuadro: r(3476, 1240, 450, 5712) },
      { id: "p457", nombre: "Álvaro", recuadro: r(3507, 837, 436, 5712) },
      { id: "p458", nombre: "Jorge", recuadro: r(3986, 783, 436, 5712) },
      { id: "p456", nombre: "Santiago", recuadro: r(3983, 1076, 460, 5712) },
    ],
  },
];
