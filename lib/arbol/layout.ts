...
//
// Pintarlo en bandas ya contestó que no: el recorrido se cuadruplica y estrechar el nodo para
// recuperarlo recorta la segunda línea a una de cada cuatro personas, que es justo lo que
// identifica a quien no trae ni apellido ni fecha. El eje no se toca; lo que se empaqueta por
// un eje y se reparte por el otro, sí: este módulo no sabe cuál de los dos se pinta a lo alto.
//
