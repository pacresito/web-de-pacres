...
// saca a los nueve Pepe y a ningún otro José, y «Marijose» solo a la Marijose. Es lo que una
...
assert.strictEqual(porNombre("Pepe").length, 9, "los nueve Pepe y ningún José más");
